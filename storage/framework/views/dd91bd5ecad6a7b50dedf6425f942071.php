...
<head>
    ...
    <title>Warranty Certificate - <?php echo e($certificate_number); ?></title>
    <?php
    ...
    <div class="warranty-container">
        ...
        <div class="header">
            <div style="display: flex; align-items: center; gap: 15px;">
                <?php if(!empty($branding->logo_path)): ?>
                    <img src="<?php echo e(Storage::url($branding->logo_path)); ?>" alt="Logo" style="max-width: 80px; max-height: 50px;">
                <?php endif; ?>
                <div>
        ...
        <div class="section">
            ...
            <div class="info-box">
                <div class="info-row">
                    ...
                    <span class="info-value"><?php echo e($project->client_name); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Location:</span>
                    <span class="info-value"><?php echo e($project->location); ?></span>
                </div>
                <div class="info-row">
                    <span class="info-label">Project ID:</span>
                    <span class="info-value">#<?php echo e($project->id); ?></span>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            <div class="dates-grid">
                <div class="date-cell">
                    ...
                    <div class="date-value"><?php echo e($issue_date ?? '—'); ?></div>
                </div>
                <div class="date-cell">
                    <div class="date-label">Valid Till</div>
                    <div class="date-value"><?php echo e($valid_till ?? '—'); ?></div>
                </div>
                <div class="date-cell">
                    <div class="date-label">Certificate No.</div>
                    <div class="date-value"><?php echo e($certificate_number); ?></div>
                </div>
            </div>
        </div>

        <!-- Surface-wise Warranty -->
        <?php if(!empty($warranty_items)): ?>
            <div class="section">
                ...
                <table class="warranty-table">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $warranty_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($item['surface']); ?></td>
                                <td><?php echo e($item['product']); ?></td>
                                <td><?php echo e($item['system']); ?></td>
                                <td class="text-center">
                                    <?php if($item['warranty_months'] > 0): ?>
                                        <span class="warranty-value"><?php echo e($item['warranty_months']); ?> Months</span>
                                    <?php else: ?>
                                        —
                                    <?php endif; ?>
                                </td>
        ...
        <div class="footer">
            <?php if(!empty($branding->support_email)): ?>
                For warranty claims: <?php echo e($branding->support_email); ?>
...
</html><?php /**PATH C:\laragon\www\paintup\resources\views/customer/warranty.blade.php ENDPATH**/ ?>