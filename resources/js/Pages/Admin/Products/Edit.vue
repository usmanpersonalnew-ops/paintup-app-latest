        ...
        <div class="max-w-4xl mx-auto px-4 py-6">
            ...
            <form @submit.prevent="submit" class="space-y-6">
                ...
                <div class="flex justify-end pt-4">
                    <button 
                        type="submit" 
                        class="bg-blue-600 text-white px-8 py-3 rounded-lg shadow-lg hover:bg-blue-700 font-bold text-lg disabled:opacity-50"
